            ...
            <div class="card-header">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center  ">
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <h3>Nivel &nbsp; {{ $nivel->nombrenivel }}</h3></div>
                    ...
                    <div class="btn-group mr-2 float-right">
                        ...
                        <input type="button" onClick="location.href = '/reportes/{{ $nivel->idnivel }}/descarga6'"
            ...
            <div class="card-body p-0 m-0" id="app">
                ...
                <div class="table-responsive">
                    ...
                    @foreach($estudiantes as $estudiante)
                        <estudiante-nivelpractica  :estudiante="{{ $estudiante }}" carrera="{{ $estudiante->carrera->nombrecarrera }}"
                                            facultad="{{ $estudiante->carrera->escuela->facultad->nombrefacultad }}"
                                            nivel="{{ $nivel->nombrenivel }}"></estudiante-nivelpractica>
                    @endforeach
                </div>
            </div>
